...
matplotlib.rc('figure', figsize=(8.,4.13))
...
class case(object):
    def __init__(self, xlsfile, ncell):
         ...
         self.sht = self.wkbk.sheet_by_name('tmean')
...
legend(bbox_to_anchor=(1.3,0.9),numpoints=1)

savefig("tmean.png",bbox_inches='tight')
savefig("tmean.pdf",bbox_inches='tight')
