...
class case(object):
    def __init__(self, xlsfile, ncell):
         ...
         self.sht = self.wkbk.sheet_by_name('dissipation')
...
savefig("dissipation.png",bbox_inches='tight')
savefig("dissipation.pdf",bbox_inches='tight')
